class Api::V2::ChecklistItemsController < Api::V2::ApiController
    ...
    def update
    	...
    	respond_to do |format|
        	format.json { render_for_api :checklists, :json => item, :root => :checklist_item}
      	end
    end
    ...
    def photo
        ...
        respond_to do |format|
            format.json { render_for_api :checklists, :json => photo.checklist_item, :root => :checklist_item}
        end
    end
